...
-  [Dependency Injection](/topics/dependency-injection.md)
    ...
    -  [Import Configuration Files/Resources](https://symfony.com/doc/6.0/service_container/import.html)
    -  [Service Arguments/References Optional](https://symfony.com/doc/6.0/service_container/optional_dependencies.html)
    -  [Service Configurator](https://symfony.com/doc/6.0/service_container/configurators.html)
    -  [Parent Services](https://symfony.com/doc/6.0/service_container/parent_services.html)
    -  [Lazy Services](https://symfony.com/doc/6.0/service_container/lazy_services.html)
    -  [Decorate Services](https://symfony.com/doc/6.0/service_container/service_decoration.html)
